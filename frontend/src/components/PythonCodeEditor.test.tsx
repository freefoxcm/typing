...
describe('PythonCodeEditor', () => {
  ...
  it('renders run and formatting controls in the tab bar without treating toolbar focus as editor blur', async () => {
    ...
    const autoSyntax = screen.getByRole('button', { name: '自动语法' })
    ...
    expect(autoSyntax.querySelector('.python-tool-auto-badge')).toHaveTextContent('A')
    expect(manualSyntax.querySelector('.python-tool-auto-badge')).toBeNull()
