...
const editorTheme = EditorView.theme({
  ...
  '& > .cm-scroller > .cm-selectionLayer .cm-selectionBackground': { background: '#315f91' },
  '&.cm-focused > .cm-scroller > .cm-selectionLayer .cm-selectionBackground': { background: '#3b73ad' },
